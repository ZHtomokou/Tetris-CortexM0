...
void InitTIMER0(void)
{
	...
	((TIMER_T *) ((( uint32_t)0x40000000) + 0x10000))->TCMPR = 27650;		
...
uint16_t _rand() 
{ 
	rd_meter = rd_meter * 29137 + 12345+ipow(rd_meter,23);
	return rd_meter % 63949; 
} 
